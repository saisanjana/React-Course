...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.firstname && firstname.length<3){
            errors.firstname='First Name length shold be greate than 3.'
        }else if(this.state.touched.firstname && firstname.length>10){
            errors.lastname='First Name length shold be less than 11.'
        }
        if(this.state.touched.lastname && lastname.length<3){
            errors.lastname='Last Name length shold be greate than 3.'
        }else if(this.state.touched.lastname && lastname.length>10){
            errors.lastname='Last Name length shold be less than 11.'
        }
        const reg=/^\d+$/;
        if(this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum='Enter valid phone number';
        }
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10} >
                                    <Input type="textarea" id="message" name="message" placeholder="Message" rows='10' value={this.state.message}
                                    onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
